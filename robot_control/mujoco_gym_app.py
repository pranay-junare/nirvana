...
from robot_control.constants import ROBOT_CONTROL_BASE_DIR
from robot_control.device import Device
from robot_control.osc import OSC
from robot_control.robot import Robot
from robot_control.utils import stderr_redirected
...
class MujocoGymApp(MujocoEnv, ABC):
    ...
    def __init__(
        ...
        full_model_path = ROBOT_CONTROL_BASE_DIR / "assets" / scene_file
        ...
        robot_config_path = ROBOT_CONTROL_BASE_DIR / "robot_configs" / robot_config_file
